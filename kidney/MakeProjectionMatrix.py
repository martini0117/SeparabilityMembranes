...
init = np.load('/Users/shomakitamiya/Documents/python/snake3D/data/KidneyContour/init/' + method + '/' +  str(cs) + '_init.npy')
...
np.save('/Users/shomakitamiya/Documents/python/snake3D/data/KidneyContour/init/' + method + '/' + str(cs) + '_dim' + str(pca_dim) + '_projection.npy',P)
