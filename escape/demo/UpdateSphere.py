...
# ノイズを乗せる
sphere = 0.6*tb.make_sphere_voxel(res,center,radius_true)
# sphere += 0.8*np.random.rand(res,res,res)

# tb.show_image_collection(sphere)
...
surf = tb.cul_contour(sphere,surf,rect_size,div=20,N_limit=1,c=0.95,ctrlpts_size=10,w=1,dif_limit=-0.01,dif_abs=False)
# tb.surf_render(surf)
print('evalpts')
# for evalp in evalpts:
