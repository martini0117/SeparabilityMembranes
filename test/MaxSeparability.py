...
for case in cases:
    ...
    surf = tb.max_cul_contour_seg(img,seg,surf,rect_size,div=40,N_limit=20,c=0.99,ctrlpts_size=cs,dif_limit=0.0,dif_abs=True,w=0.95,ctrlpts_increasing=True,increasing_limit=0.01,weight=0.5)
